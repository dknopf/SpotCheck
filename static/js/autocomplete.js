...
function autocomplete(inp, arr) {
    ...
    inp.addEventListener("input", function (e) {
        ...
        for (i = 0; i < arr.length; i++) {
            ...
            if (arr[i].substr(0, val.length).toUpperCase() == val.toUpperCase() && a.childElementCount < 5) {
                ...
                b.addEventListener("click", function (e) {
                    ...
                    inp.value = this.getElementsByTagName("input")[0].value.concat(', ');
...
autocomplete(document.getElementById("autocomplete"), course_list_js);
